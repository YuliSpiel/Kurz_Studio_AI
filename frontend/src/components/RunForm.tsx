...
export default function RunForm({ onRunCreated, onAuthRequired, enhancementData }: RunFormProps) {
  ...
  const [numCharacters, setNumCharacters] = useState<number>(2)
  ...
  useEffect(() => {
    if (enhancementData) {
      ...
      setNumCharacters(enhancement.suggested_num_characters)
  ...
  const handleApplyEnhancement = () => {
    ...
    setNumCharacters(enhancementResult.suggested_num_characters)
